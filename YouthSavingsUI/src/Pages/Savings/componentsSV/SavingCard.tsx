        ...
        <CardContainer className={combinedClasses}>
          <CardBody className="w-full h-full">
            <div className="relative w-full h-full">
              <CardItem className="absolute ~top-2/5 left-0 right-0 ~text-xs/2xl font-montserrat font-bold flex justify-around w-full">
              ...
              <CardItem className="absolute ~top-12/28 left-0 right-0 mx-auto w-8/12">
                <ProcessBar funda={current} total={total} />
              </CardItem>

              <CardItem className="absolute bottom-1 flex justify-center w-full ">
