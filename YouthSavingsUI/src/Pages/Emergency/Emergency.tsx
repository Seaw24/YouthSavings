...
const Emergency = ({fundamental, niceToHave , income , totalSaving} : EmergencyProps) => {
    const title =[
        {
            text : 'Emergency',
        },
  ...
  return (
    ...
    <div className=' flex justify-center items-center flex-col ~gap-4/6  w-full  h-[30%]'>
        ...
        <TypewriterEffect words={title} className=' ~text-5xl/8xl font-extrabold text-center   ' cursorClassName='opacity-0'/> 
        <TypewriterEffectSmooth words = {desc} className='text-highlight ~mb-6/11 ~text-base/lg '/>
    ...
    <Input income= {income} fundamental ={fundamental} niceToHave ={niceToHave} totalSaving={totalSaving}  />
    </div>
